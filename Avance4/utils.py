...
class Processor_data():
    ...
    def apply_non_breaking_prefix(self, text, language="en"):
        ...
        if language == "en":
            non_breaking_prefix = open_txt("P85-Non-Breaking-Prefix.en")
        elif language == "es":
            non_breaking_prefix = open_txt("P85-Non-Breaking-Prefix.es")
        elif language == "fr":
            non_breaking_prefix = open_txt("P85-Non-Breaking-Prefix.fr")
        else:
